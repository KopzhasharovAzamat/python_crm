...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Отзывы
        reviews_data = [
            {'name': 'Кымбат', 'city': 'Москва', 'avatar': 'rus2.jpg', 'review': 'Купил диван, качество на высоте!'},
            {'name': 'Мария Петрова', 'city': 'Санкт-Петербург', 'avatar': 'rus8.jpg', 'review': 'Обеденный стол великолепен.'},
            {'name': 'Иван Смирнов', 'city': 'Екатеринбург', 'avatar': 'rus3.jpg', 'review': 'Кресло очень удобное.'},
            {'name': 'Ольга Кузнецова', 'city': 'Новосибирск', 'avatar': 'rus10.jpg', 'review': 'Кухонный гарнитур идеален.'},
            {'name': 'Дмитрий Васильев', 'city': 'Казань', 'avatar': 'rus5.jpg', 'review': 'Стулья и диван отличные.'},
            {'name': 'Юлия Александрова', 'city': 'Челябинск', 'avatar': 'rus6.jpg', 'review': 'Шкаф функциональный.'},
            {'name': 'Анатолий Григорьев', 'city': 'Ростов-на-Дону', 'avatar': 'rus2.jpg', 'review': 'Комод качественный.'},
            {'name': 'Екатерина Сидорова', 'city': 'Самара', 'avatar': 'rus3.jpg', 'review': 'Спальный гарнитур шикарный.'},
            {'name': 'Сергей Иванов', 'city': 'Омск', 'avatar': 'rus8.jpg', 'review': 'Ванная мебель стильная.'},
        ]
